...
//         }
            steps {
            sh 'docker build -t 471112727668.dkr.ecr.us-east-1.amazonaws.com/expense-parameters-init:${TAG_NAME} .'
            ...
            sh 'docker push 471112727668.dkr.ecr.us-east-1.amazonaws.com/expense-parameters-init:${TAG_NAME}'
            }
       }
     }
   }
